...
// :: ${function (blines) {return `<pre class=my_box>${this.flatten(blines).join('')}</pre>`}}
var box = Grit`
    box    := bxline* :: string
...
module.exports.box = function (src, ctx) {
	return `<pre class=my_box>${box.parse(src)}</pre>`;
}
